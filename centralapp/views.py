...
def classification1(request):
    if request.method == 'POST' and request.FILES['upload']:
        ...
        if fn!="":
            ...
            model = load_model(r'D:\Update\updated_MediPharma breast cancer web 100%\updated_MediPharma breast cancer web 100%\MediPharma breast cancer web 100%\MediPharma\breast_cancerbreast.h5',compile=False)
...
def classificationsvm(request):
    if request.method == 'POST' and request.FILES['upload']:
        ...
        if fn!="":
            ...
            model = load_model(r'D:\Update\updated_MediPharma breast cancer web 100%\updated_MediPharma breast cancer web 100%\MediPharma breast cancer web 100%\MediPharma\breast_cancer_svm.pkl',compile=False)
