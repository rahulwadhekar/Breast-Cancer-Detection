def main():
    ...
    basepath="C:\Users\GAURI\Downloads\updated_MediPharma breast cancer web 100%\updated_MediPharma breast cancer web 100%\MediPharma breast cancer web 100%\MediPharma"
    ...
    #Saving the model
    #import h5py
    classifier.save(basepath + '/breast_cancerbreast.h5')
